...
namespace ChatBot.Bot.Plugins
{
    ...
    public class Command
    {
        ...
        public BotCommandRestriction restriction;
        ...
        public Command(string cmd, BotCommandRestriction rest, CommandSecurity cmdSecurity, string description = null, string tags = null)
        {
            command = cmd;
            restriction = rest;
