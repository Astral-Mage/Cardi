    ...
    public partial class GameCore : PluginBase
    {
        ...
        public List<Command> GetCommandList()
        {
            return new List<Command>
            {
                ...
                new Command(CommandStrings.Prog, ChatTypeRestriction.Both, CommandSecurity.None, "shows the current floor's progress"),
                new Command(CommandStrings.Gift, ChatTypeRestriction.Message, CommandSecurity.None, "gifts gold to a player"),
                new Command(CommandStrings.Set, ChatTypeRestriction.Whisper, CommandSecurity.None, "sets various card things", "help"),
                new Command(CommandStrings.Upgrade, ChatTypeRestriction.Whisper, CommandSecurity.None, "upgrades your gear for gold", "help"),
                new Command(CommandStrings.Card, ChatTypeRestriction.Both, CommandSecurity.None, "shows off your condensed character card"),
                new Command(CommandStrings.Cooldown, ChatTypeRestriction.Both, CommandSecurity.None, "shows your current dive cooldown"),
                new Command(CommandStrings.Gold, ChatTypeRestriction.Both, CommandSecurity.None, "shows your current rank in the leaderboard"),
                new Command(CommandStrings.Leaderboard, ChatTypeRestriction.Both, CommandSecurity.None, "shows the monster leaderboard"),
                new Command(CommandStrings.Mute, ChatTypeRestriction.Both, CommandSecurity.Ops, "mutes all in-room conversation if enabled"),
                new Command(CommandStrings.Smite, ChatTypeRestriction.Both, CommandSecurity.Ops, "subtracts gold from a player"),
                new Command(CommandStrings.Execute, ChatTypeRestriction.Both, CommandSecurity.Ops, "deletes a player's card", "name"),
                new Command(CommandStrings.BaseCooldown, ChatTypeRestriction.Both, CommandSecurity.Ops, "changes the base cooldown"),
                new Command(CommandStrings.AddFloor, ChatTypeRestriction.Whisper, CommandSecurity.Ops, "adds a new dungeon floor"),
                new Command(CommandStrings.Deck, ChatTypeRestriction.Both, CommandSecurity.None, "creates a new deck of playing cards with specified players"),
                new Command(CommandStrings.JoinChannel, ChatTypeRestriction.Whisper, CommandSecurity.Ops, "joins a channel"),
                new Command(CommandStrings.Roll, ChatTypeRestriction.Whisper, CommandSecurity.Ops, "spends gold to roll in the gatcha"),
            };
        }
